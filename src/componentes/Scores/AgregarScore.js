            ...
            <React.Fragment>
                ...
                <form onSubmit={this.agregarScore}>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="score" placeholder="Digite su calificacion" name="score" ref={this.score} onChange={this.changeState} />
                    </div>
                    <div className="mb-3">
                        <label for="descripcion" className="form-label">Descripcion</label>
                        <input type="text" className="form-control" id="descripcion" placeholder="Ingrese la experiencia con el servicio" name="descripcion" ref={this.descripcion} onChange={this.changeState} />
                    </div>
