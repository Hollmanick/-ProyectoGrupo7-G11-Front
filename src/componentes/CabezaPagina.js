    ...
    render() {
        return (
            <div>
                ...
                <img data-src="https://storage.googleapis.com/alquilatucarrocom/images/carros.png" className="img-fluid mx-auto lazyloaded" title="alquiler de carros en Colombia" alt="alquiler de carros en Bogotá" src="https://storage.googleapis.com/alquilatucarrocom/images/carros.png" />
                ...
                <div className="row">
                    ...
                    <div className="col-md">
                        ...
                        <img data-src="https://storage.googleapis.com/alquilatucarrocom/landing2020/images/cobertura.svg" width="65" height="65" className="img-fluid mx-auto lazyloaded" alt="cobertura" src="https://storage.googleapis.com/alquilatucarrocom/landing2020/images/cobertura.svg" />
                    </div>

                    <div className="col-md">
                        <h4><strong>Mejor Protección</strong></h4>
                        <img data-src="https://storage.googleapis.com/alquilatucarrocom/landing2020/images/proteccion.svg" width="65" height="65" className="img-fluid mx-auto lazyloaded" alt="proteccion" src="https://storage.googleapis.com/alquilatucarrocom/landing2020/images/proteccion.svg" />
                    </div>
                    <div className="col-md"></div>
                </div>
            </div>
